...
@Autonomous(name = "Blue Far 3", group = "Blue 3")
public class BlueFar3 extends OpMode {
    ...
    private final Pose shootPose = new Pose(59, 15, Math.toRadians(111));
    ...
    private final Pose LaunchClearance = new Pose(15,13, Math.toRadians(180));
