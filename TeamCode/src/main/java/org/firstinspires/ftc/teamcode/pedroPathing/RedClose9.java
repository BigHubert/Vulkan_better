...
import org.firstinspires.ftc.teamcode.pedroPathing.BlueClose9;
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;
@Autonomous(name = "Red Close 9, 1 clear", group = "Red 9")
public class RedClose9 extends OpMode {
    ...
    private final Pose EndofBalls1 = new Pose(125,85, Math.toRadians(0));
    private final Pose Startofballs2 = new Pose(100,60.5, Math.toRadians(0));
    private final Pose EndofBalls2 = new Pose(127,60.5, Math.toRadians(0));
    ...
    private final Pose ClearRamp2 = new Pose(120,74, Math.toRadians(0));
        ...
        switch(pathState){
            ...
            case CLEAR_RAMP1:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 1) {
                    ...
                    setPathState(RedClose9.PathState.CLEAR_RAMP2);
                    Shooter.setPower(0);
                    IntakeMotor.setPower(0);
                    Pusher.setPower(0);
                }
            ...
            case CLEAR_RAMP2:
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 1) {
                    ...
                    setPathState(RedClose9.PathState.SHOOT1);
                }
            case SHOOT1 :
                if (!follower.isBusy() && pathTimer.getElapsedTimeSeconds() > 1){
