...
@Autonomous(name = "Red Far 3", group = "Red 3")
public class RedFar3 extends OpMode {
    ...
    private final Pose shootPose = new Pose(85, 15, Math.toRadians(66));
    ...
    private final Pose LaunchClearance = new Pose(130,13, Math.toRadians(0));
